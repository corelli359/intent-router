...
_CARD_NUMBER_SLOT = SlotDefinition(slot_key="card_number", value_type=SlotValueType.ACCOUNT_NUMBER)
_PHONE_LAST4_SLOT = SlotDefinition(slot_key="phone_last4", value_type=SlotValueType.PHONE_LAST4)
