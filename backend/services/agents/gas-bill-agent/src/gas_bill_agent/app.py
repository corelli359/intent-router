...
from .service import GasBillPaymentAgentRequest, GasBillPaymentAgentService


@lru_cache
def get_settings() -> AgentLLMSettings:
    return AgentLLMSettings.from_env(prefix="GAS_BILL_AGENT", service_name="gas-bill-agent")


@lru_cache
def get_service() -> GasBillPaymentAgentService:
...
def create_app() -> FastAPI:
    ...
    async def run_agent(
        ...
        service: GasBillPaymentAgentService = Depends(get_service),
    ) -> StreamingResponse:
