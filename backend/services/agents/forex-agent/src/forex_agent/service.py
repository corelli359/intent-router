...
_CARD_SLOT = SlotDefinition(slot_key="card_number", value_type=SlotValueType.ACCOUNT_NUMBER)
_PHONE_SLOT = SlotDefinition(slot_key="phone_last4", value_type=SlotValueType.PHONE_LAST4)
_SOURCE_CURRENCY_SLOT = SlotDefinition(slot_key="source_currency", value_type=SlotValueType.STRING)
_TARGET_CURRENCY_SLOT = SlotDefinition(slot_key="target_currency", value_type=SlotValueType.STRING)
