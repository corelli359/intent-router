...
_RECIPIENT_NAME_SLOT = SlotDefinition(slot_key="recipient_name", value_type=SlotValueType.PERSON_NAME)
_RECIPIENT_CARD_SLOT = SlotDefinition(slot_key="recipient_card_number", value_type=SlotValueType.ACCOUNT_NUMBER)
_RECIPIENT_PHONE_SLOT = SlotDefinition(
